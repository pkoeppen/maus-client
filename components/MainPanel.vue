    ...
    <simplebar class="h-full">
      <main>
                  ...
                  <nuxt-link to="/channel/featured">
                    <div class="flex space-x-2">
                      ...
                      <div>
                        <nuxt-link
                          to="/channel/featured"
                          class="block font-bold text-sm hover:underline"
                          >Featured Channel</nuxt-link
                        >
        ...
        <section class="p-6">
          ...
          <div
            v-else
            class="flex flex-wrap grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-6"
          >
            <div v-for="(creator, n) of creators.slice(0, 4)" :key="n">
              <nuxt-link :to="`/watch?v=${n}`">
                <div class="relative aspect-ratio-16/9">
                  <div class="absolute inset-0">
                    <img
                      :src="`https://picsum.photos/seed/${n}/400/225`"
                      class="object-cover"
                    />
                  </div>
                  <div
